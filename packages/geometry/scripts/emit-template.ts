...
console.log(`  to the cut   : ${(g.topArcMm + p.margins.cut.leftMm + p.margins.cut.rightMm).toFixed(2)} x ${(g.slantMm + p.margins.cut.topMm + p.margins.cut.bottomMm).toFixed(2)} mm`);
